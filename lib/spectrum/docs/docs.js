...
$(function() {
  $("#full").spectrum({
    ...
    move : function(color) { updateBorders(color); },
    show : function() {
    ...
    hide : function(color) { updateBorders(color); },
  ...
  $("#hideButtons").spectrum({showButtons : false, change : updateBorders});
  ...
  $("#disabled").spectrum({disabled : true});
  ...
  $("#flat").spectrum({flat : true, showInput : true, move : updateBorders});
  ...
  $("#className").spectrum({className : 'awesome'});
  ...
  var textPalette = [
    "rgb(255, 255, 255)", "rgb(204, 204, 204)", "rgb(192, 192, 192)",
    "rgb(153, 153, 153)", "rgb(102, 102, 102)", "rgb(51, 51, 51)",
    "rgb(0, 0, 0)",       "rgb(255, 204, 204)", "rgb(255, 102, 102)",
    "rgb(255, 0, 0)",     "rgb(204, 0, 0)",     "rgb(153, 0, 0)",
    "rgb(102, 0, 0)",     "rgb(51, 0, 0)",      "rgb(255, 204, 153)",
    "rgb(255, 153, 102)", "rgb(255, 153, 0)",   "rgb(255, 102, 0)",
    "rgb(204, 102, 0)",   "rgb(153, 51, 0)",    "rgb(102, 51, 0)",
    "rgb(255, 255, 153)", "rgb(255, 255, 102)", "rgb(255, 204, 102)",
    "rgb(255, 204, 51)",  "rgb(204, 153, 51)",  "rgb(153, 102, 51)",
    "rgb(102, 51, 51)",   "rgb(255, 255, 204)", "rgb(255, 255, 51)",
    "rgb(255, 255, 0)",   "rgb(255, 204, 0)",   "rgb(153, 153, 0)",
    "rgb(102, 102, 0)",   "rgb(51, 51, 0)",     "rgb(153, 255, 153)",
    "rgb(102, 255, 153)", "rgb(51, 255, 51)",   "rgb(51, 204, 0)",
    "rgb(0, 153, 0)",     "rgb(0, 102, 0)",     "rgb(0, 51, 0)",
    "rgb(153, 255, 255)", "rgb(51, 255, 255)",  "rgb(102, 204, 204)",
    "rgb(0, 204, 204)",   "rgb(51, 153, 153)",  "rgb(51, 102, 102)",
    "rgb(0, 51, 51)",     "rgb(204, 255, 255)", "rgb(102, 255, 255)",
    "rgb(51, 204, 255)",  "rgb(51, 102, 255)",  "rgb(51, 51, 255)",
    "rgb(0, 0, 153)",     "rgb(0, 0, 102)",     "rgb(204, 204, 255)",
    "rgb(153, 153, 255)", "rgb(102, 102, 204)", "rgb(102, 51, 255)",
    "rgb(102, 0, 204)",   "rgb(51, 51, 153)",   "rgb(51, 0, 153)",
    "rgb(255, 204, 255)", "rgb(255, 153, 255)", "rgb(204, 102, 204)",
    "rgb(204, 51, 204)",  "rgb(153, 51, 153)",  "rgb(102, 51, 102)",
    "rgb(51, 0, 51)"
  ];
  ...
  $("#clickoutFiresChange").spectrum({change : updateBorders});

  $("#clickoutDoesntFireChange")
      .spectrum({change : updateBorders, clickoutFiresChange : false});

  $("#showInitial").spectrum({showInitial : true});

  $("#showInputAndInitial").spectrum({showInitial : true, showInput : true});

  $("#showInputInitialClear")
      .spectrum({allowEmpty : true, showInitial : true, showInput : true});
  ...
  $("#eventshow").spectrum({
    show : function(c) {
      ...
      label.text("show called at " + prettyTime() + " (color is " +
                 c.toHexString() + ")");
    }
  });
  ...
  $("#eventhide").spectrum({
    hide : function(c) {
      ...
      label.text("hide called at " + prettyTime() + " (color is " +
                 c.toHexString() + ")");
    }
  });
  ...
  $("#eventdragstart")
      ...
      .on("dragstart.spectrum", function(e, c) {
        ...
        label.text("dragstart called at " + prettyTime() + " (color is " +
                   c.toHexString() + ")");
      });
  ...
  $("#eventdragstop")
      ...
      .on("dragstop.spectrum", function(e, c) {
        ...
        label.text("dragstop called at " + prettyTime() + " (color is " +
                   c.toHexString() + ")");
      });

  $(".basic").spectrum({change : updateBorders});
  $(".override").spectrum({color : "yellow", change : updateBorders});

  $(".startEmpty").spectrum({allowEmpty : true, change : updateBorders});

  $("#beforeShow").spectrum({beforeShow : function() { return false; }});
  ...
  $("#showSelectionPaletteStorage").spectrum({
    showPalette : true,
    localStorageKey : "spectrum.homepage", // Any picker with the same string
                                           // will share selection
    showSelectionPalette : true,
    palette : []
  });
  ...
  $("#triggerSet").spectrum({change : updateBorders});
  ...
  $('#toc').toc({
    ...
    'highlightOnScroll' :
        true,                // add class to heading that is currently in focus
    'highlightOffset' : 100, // offset to trigger the next headline
    'anchorName' : function(i, heading,
                            prefix) { // custom function for anchor name
