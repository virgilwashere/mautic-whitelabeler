...
if (typeof module === "object" && typeof module.exports === "object") {
  ...
  // inherently posses a window with a document (such as Node.js), expose a
  // jQuery-making factory as module.exports This accentuates the need for the
  // creation of a real window e.g. var jQuery = require("jquery")(window); See
  // ticket #14549 for more info
...
jQuery.extend({
  ...
  map : function(elems, callback, arg) {
    var value, i = 0, length = elems.length, isArray = isArraylike(elems),
               ret = [];
...
var Sizzle =
    ...
    (function(window) {
      var i, support, Expr, getText, isXML, compile, outermostContext,
          ...
          expando = "sizzle" + -(new Date()), preferredDoc = window.document,
          ...
          // http://www.w3.org/TR/css3-selectors/#attribute-selectors Proper
          // syntax:
          ...
          matchExpr = {
            ...
            "TAG" :
                new RegExp("^(" + characterEncoding.replace("w", "w*") + ")"),
      ...
      function Sizzle(selector, context, results, seed) {
        ...
        if (documentIsHTML && !seed) {
          ...
          if (support.qsa && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
            ...
            // technique) IE 8 doesn't work on object elements
      ...
      setDocument = Sizzle.setDocument = function(node) {
        ...
        // has been reloaded, IE will throw "permission denied" error when
        // accessing "document" variable, see jQuery #13936 IE6-8 do not support
        // the defaultView property so parent will be undefined
        if (parent && parent !== parent.top) {
          // IE11 does not have attachEvent, so all must suffer
          if (parent.addEventListener) {
            parent.addEventListener("unload", function() { setDocument(); },
                                    false);
      ...
      */
        ...
        support.getElementsByClassName =
            rnative.test(doc.getElementsByClassName) && assert(function(div) {
      ...
      */
        ...
        if ((support.matchesSelector =
                 rnative.test((matches = docElem.webkitMatchesSelector ||
      ...
      function matcherFromGroupMatchers(elementMatchers, setMatchers) {
        var bySet = setMatchers.length > 0,
            ...
            superMatcher = function(seed, context, xml, results, outermost) {
              ...
              // will be "00" below Support: IE<9, Safari Tolerate NodeList
              // properties (IE: "length"; Safari: <number>) matching elements
              // by id
...
function winnow(elements, qualifier, not) {
  ...
  return jQuery.grep(
      elements,
      function(elem) { return (indexOf.call(qualifier, elem) >= 0) !== not; });
}
...
jQuery.extend({
  hasData : function(
      elem) { return data_user.hasData(elem) || data_priv.hasData(elem); },

  data : function(elem, name,
                  data) { return data_user.access(elem, name, data); },
  ...
  _data : function(elem, name,
                   data) { return data_priv.access(elem, name, data); },
...
jQuery.fn.extend({
  data : function(key, value) {
    ...
    if (typeof key === "object") {
      return this.each(function() { data_user.set(this, key); });
    }
  ...
  removeData : function(
      key) { return this.each(function() { data_user.remove(this, key); }); }
});
...
jQuery.event = {
  ...
  add : function(elem, types, handler, data, selector) {
    var handleObjIn, eventHandle, tmp, events, t, handleObj, special, handlers,
        type, namespaces, origType, elemData = data_priv.get(elem);
    ...
    if (!(eventHandle = elemData.handle)) {
      eventHandle = elemData.handle = function(e) {
        ...
        return typeof jQuery !== strundefined && jQuery.event.triggered !== e.type ? jQuery
                                                                                         .event
                                                                                         .dispatch
                                                                                         .apply(
                                                                                             elem,
  ...
  simulate : function(type, elem, event, bubble) {
    ...
    var e =
        jQuery.extend(new jQuery.Event(), event,
...
// Support: Chrome 15+
jQuery.each(
    {mouseenter : "mouseover", mouseleave : "mouseout"}, function(orig, fix) {
...
function setGlobalEval(elems, refElements) {
  ...
  for (; i < l; i++) {
    data_priv.set(elems[i], "globalEval",
...
jQuery.fn.extend({
  ...
  domManip : function(args, callback) {
    ...
    var fragment, first, scripts, hasScripts, node, doc,
        i = 0, l = this.length, set = this, iNoClone = l - 1, value = args[0],
...
function actualDisplay(name, doc) {
  var elem = jQuery(doc.createElement(name)).appendTo(doc.body),
      ...
      display = window.getDefaultComputedStyle
                    ...
                    // optmization) until something better comes along, since it
                    // was removed from specification and supported only in FF
...
function curCSS(elem, name, computed) {
  ...
  if (computed) {
    ...
    // width seems to be reliably pixels this is against the CSSOM draft spec:
  ...
  return {
    get : function() {
      if (conditionFn()) {
        ...
        // dependency), remove it. Since there are no other hooks for
...
if (window.getComputedStyle) {
  jQuery.extend(support, {
    ...
    reliableMarginRight : function() {
      ...
      // margin-right This support function is only executed once so no
      // memoizing is needed.
...
function vendorPropName(style, name) {
  ...
  var capName = name[0].toUpperCase() + name.slice(1), origName = name,
  ...
  for (; index < length; index++) {
    ...
    if (show) {
      ...
      if (elem.style.display === "" && isHidden(elem)) {
        values[index] =
            data_priv.access(elem, "olddisplay", defaultDisplay(elem.nodeName));
      }
    } else {
...
jQuery.extend({
  ...
  style : function(elem, name, value, extra) {
    ...
    if (value !== undefined) {
      ...
      // Fixes #8908, it can be done more correctly by specifying setters in
      ...
      if (!hooks || !("set" in hooks) ||
        ...
        // Setting style to blank string required to delete "style: x
        // !important;"
        style[name] = "";
        style[name] = value;
      }
...
var fxNow, timerId,
    ...
    rrun = /queueHooks$/, animationPrefilters = [ defaultPrefilter ],
    tweeners = {
      "*" : [ function(prop, value) {
  ...
  for (prop in props) {
    ...
    if (rfxtypes.exec(value)) {
      ...
      if (value === (hidden ? "hide" : "show")) {
        ...
        // If there is dataShow left over from a stopped hide or show and we are
        // going to proceed with show, we should pretend to be hidden
...
function Animation(elem, properties, options) {
  var result, stopped,
      index = 0, length = animationPrefilters.length,
  ...
  stop : function(type, clearQueue, gotoEnd) {
    ...
    return this.each(function() {
      var dequeue = true, index = type != null && type + "queueHooks",
          timers = jQuery.timers, data = data_priv.get(this);
...
jQuery.fn.extend({
  addClass : function(value) {
    var classes, elem, cur, clazz, j, finalValue,
        proceed = typeof value === "string" && value, i = 0, len = this.length;
