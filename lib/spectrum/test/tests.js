...
test("replacerClassName", function() {
  var el = $("<input />")
    .appendTo("body")
    .spectrum({ replacerClassName: "test" });
  ok(
...
test("containerClassName", function() {
  var el = $("<input />")
    .appendTo("body")
    .spectrum({ containerClassName: "test" });
  ok(
...
test("Options Can Be Set and Gotten Programmatically", function() {
  ...
  var appendToParent = $("<input />")
    .appendTo("#c")
    .spectrum({ appendTo: "parent" });
